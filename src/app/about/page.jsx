      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            {/* BIOGRAPHY IMAGE */}
            <Image
              src="/profile.jpg"  // or /images/profile.jpg based on your path
              alt="Anshu - Resin Artist"
              width={112}
              height={112}
            ...
            <p className="text-lg">
              ...
              What started as a passion project soon became my purpose&mdash;preserving life&apos;s most precious moments in resin, 
              ...
              <br /><br />
              Resin isn&apos;t just a material for me&mdash;it&apos;s a medium of storytelling. I believe every item has a story, 
              ...
              the world to you&mdash;I&apos;m here to help you turn it into art that speaks to your soul.
            </p>
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                   Started on Whatsapp for family and friends
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Received enquiry through Whatsapp
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2022
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Majority of orders are coming from Instagram
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2024
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    Completed 400+ orders
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                   Orders are coming from various social medial.
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2025
